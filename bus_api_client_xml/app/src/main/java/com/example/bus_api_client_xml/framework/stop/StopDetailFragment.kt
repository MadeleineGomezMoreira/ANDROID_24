...
import com.example.bus_api_client_xml.framework.driver.DriverDetailContract
import com.example.bus_api_client_xml.framework.line.BusLineDetailFragmentDirections
...
class StopDetailFragment : Fragment() {
    ...
    //TODO: fix lines not showing (loading till timeout) + LOCATION NOT SHOWING CORRECTLY (0,0)
